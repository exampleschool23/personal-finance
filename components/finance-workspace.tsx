...
function WorkspaceContent() {
    ...
    const basePlanning = usePlanning(user, demo, rows, reload, refreshRecords, demoHoldingAccounts, section==='Accounts'?'full':section==='Overview'?'review':'workspace');
 ...
 {section==='Overview'&&!planning.loading&&!planning.error&&<div className="content review-content"><MonthlyReview market={market} data={planning.data} tools={transactionTools} snapshots={snapshots.snapshots} historyError={snapshots.error} currency={currency}/></div>}
</main>
