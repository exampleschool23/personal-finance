...
import { useEffect, useState, useRef, useEffectEvent, type MouseEvent as ReactMouseEvent, type KeyboardEvent as ReactKeyboardEvent } from 'react';
...
function WorkspaceContent() {
    ...
    const [cashflowTab,setCashflowTab]=useState('Overview');
