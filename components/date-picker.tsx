...
function MonthCalendar({ monthKey, draft, min, onSelect, onYearChange, previous, next }: { monthKey: string; draft: string; min?: string; onSelect: (date: string) => void; onYearChange: (year: number) => void; previous?: () => void; next?: () => void }) {
  const { locale, t } = useLanguage();
