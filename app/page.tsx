...
export default function Home() {
    ...
    const quoteLabel = (entry: Entry) => {
        ...
        const time = new Intl.DateTimeFormat(locale, { dateStyle: 'short', timeStyle: 'short' }).format(new Date(quote.marketTime || quote.fetchedAt));
