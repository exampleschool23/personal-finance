...
function WorkspaceContent() {
    ...
    const addCashFlow = (kind: Entry['kind']) => { setError(''); setRecordKinds(income.includes(kind) ? income : expenses); setEditing({ ...fresh(), currency, kind, frequency: income.includes(kind)?'Monthly':'Once' }); };
    const addRecord = () => {
