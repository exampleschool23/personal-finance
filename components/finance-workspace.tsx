...
function WorkspaceContent() {
    ...
    const expensePlans = useExpensePlans(user, demo, rows, reload, refreshRecords, forecastMonth);
    useEffect(() => {
