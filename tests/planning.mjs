...
const {upcomingPayments,goalProgress}=new Function('income','expenses','depositToday',source+';return {upcomingPayments,goalProgress};')(income,expenses,depositToday);
import {parseCSV,mapCSV,exportCSV} from '../lib/csv.ts';
