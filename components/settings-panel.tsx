...
export function SettingsPanel({ initial, demo, onSaved, loading, loadError }: { initial: Preferences; demo: boolean; onSaved: (p: Preferences) => void; loading: boolean; loadError: string }) {
