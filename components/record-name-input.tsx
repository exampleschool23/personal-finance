...
export function RecordNameInput({ entry, rows, onChange, placeholder, label }: { entry: Entry; rows: Entry[]; onChange: (name: string) => void; placeholder: string; label?: string }) {
