...
test('record API verifies dated rate, preserves saved conversions on retry, and rejects forged rates',async()=>{
 ...
 const post=new Function('loadDatedExchangeRate','depositForecasts','isCurrency','z','kinds','income','expenses','assetRecordKinds','session','supa','sameOrigin',compile('app/api/records/route.ts')+';return POST;')(
