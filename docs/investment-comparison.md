...
### Overview net-worth overlay

Overview benchmarks use the opening net worth of the selected chart period, including cash and subtracting debts. They invest that amount once at the period's opening price, with no later funding or withdrawals. Changing the period resets both opening capital and purchase date. The standalone Benchmarks page continues to compare dated investment funding; its balances must never be overlaid directly on net worth. Simulations use USD and convert back at current display rates so changing display currency does not change hypothetical purchases. Missing prices remain unavailable; negative opening net worth cannot fund a hypothetical investment.
