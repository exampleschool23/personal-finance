...
function WorkspaceContent() {
    ...
    async function save(e: React.FormEvent) { e.preventDefault(); if (!editing)
        ...
        if (demo) {
            ...
            setRows(withAssetIncomePlans([savedRecord,...updated],earningSources.sources));
        }
        else refreshRecords();
        setEditing(null);
    }
